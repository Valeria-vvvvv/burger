...
export const ProductCard = ({ details }) => {
  ...
  const { id, name, description, price, weight, image } = details;
   ...
   * Использует централизованный импорт изображений
   *
   * @param {string} imageName - имя файла изображения (например: "1.png")
   * @returns {string|null} - путь к изображению или null при ошибке
   */
  const getImagePath = (imageName) => {
    return burgerImages[imageName] || null;
  };
  ...
  return (
    ...
    <div className="product-card">
      ...
      <div className="product-image">
        <img
          src={getImagePath(image)} // Динамически загруженное изображение
